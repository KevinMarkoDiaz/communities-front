...
export default function CardPromoHome({
  ...
  return (
    <div className="relative w-[220px] sm:w-[280px] md:w-[300px] lg:w-[245px] xl:w-[225px] aspect-[4/6] md:aspect-[5/3] xl:aspect-[5/6]  rounded-[1.5rem] overflow-hidden shadow-md bg-gray-100 transition hover:shadow-lg mb-4">
      {/* Imagen de fondo */}
      {image && (
        <div
