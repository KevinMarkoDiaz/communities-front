...
import { FiMessageCircle, FiMapPin, FiGlobe, FiUser } from "react-icons/fi";
    ...
    <div className="flex flex-col gap-4 md:flex-col lg:flex-row lg:justify-between lg:items-end bg-[#f9fafb] p-4 md:p-6 rounded-2xl">
      ...
      <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center sm:items-start">
        ...
        <div className="flex flex-col gap-1 text-center sm:text-left">
          ...
          {title && (
            <p className="text-[#6b7280] text-xs sm:text-sm md:text-base font-medium flex items-center gap-1">
          ...
          {location && (
            <p className="text-[#6b7280] text-xs sm:text-sm md:text-base font-normal flex items-center gap-1">
              <FiMapPin className="text-gray-400" />
              {location}, {country}
            </p>
          )}

          <p className="text-[#6b7280] text-xs  font-normal capitalize">
      ...
      {/* Descripción */}
      {description && (
        <div className="mt-2 md:mt-4 lg:mt-0 lg:max-w-xl text-sm text-gray-600 leading-snug">
          {description}
        </div>
      )}
